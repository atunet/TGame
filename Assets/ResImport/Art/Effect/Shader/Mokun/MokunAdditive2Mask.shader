...
Shader "MoKun/Multiply Two Mask" {
Properties {
	_TintColor ("Tint Color", Color) = (0.5,0.5,0.5,0.5)
	_MainTex ("Particle Texture", 2D) = "white" {}
	_MaskTex ("Detail Texture", 2D) = "white" {}
	_MaskTex1 ("Detail Texture1", 2D) = "white" {}
	...
	SubShader {
		Pass {
			...
			v2f vert (appdata_t v)
			{
				...
				o.texcoord1.xy = v.texcoord.xy * _MaskTex1_ST.xy + _MaskTex1_ST.zw;
				return o;
			}
			...
			//return float4(1,1,1,1);
				...
				* tex2D(_MaskTex, i.texcoord.zw)* tex2D(_MaskTex1, i.texcoord1.xy) ;
